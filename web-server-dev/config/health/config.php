...
return [
    ...
    */
    ...
    "assets" => [
        "css" => base_path("vendor/pragmarx/health/src/resources/dist/css/app.css"),

        "js" => base_path("vendor/pragmarx/health/src/resources/dist/js/app.js"),
    ],
    ...
    "routes" => [
        "prefix" => ($route_prefix = "/api/health"),
