...
Route::group(
    ...
    function () {
        ...
        Route::post("tin-nhan-chuyen-khoan", [BaoLoiController::class, "transferMessage"]);

        Route::delete("bao-loi-id/{id}", [BaoLoiController::class, "adminDelete"]);
        Route::post("tin-nhan-chuyen-khoan", [BaoLoiController::class, "transferMessage"]); //lấy tin nhắn chuyển khoản
        Route::post("bao-loi-detail/{id}", [BaoLoiController::class, "getBaoLoiDetails"]); //cap nhat trang thai
    }
);
Route::group(
    [
    ...
    function () {
        ...
        Route::post("bao-loi-phuc-khao", [BaoLoiController::class, "baoLoiPhucKhao"]);
    }
);
