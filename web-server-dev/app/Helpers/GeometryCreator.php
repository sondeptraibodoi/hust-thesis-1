...
class GeometryCreator
{
    ...
    public static function fake($type)
    {
        if ($type === "MStaack\LaravelPostgis\Geometries\Polygon") {
            return Polygon::fromString(
                "POLYGON ((105.27099609375 20.704738720055513, 106.34765625 20.704738720055513, 106.34765625 21.46329344189928, 105.27099609375 21.46329344189928, 105.27099609375 20.704738720055513))"
            );
        } elseif ($type === "MStaack\LaravelPostgis\Geometries\Point") {
    ...
    public static function fakeRaw($type)
    {
        $wkt = null;
