...
/*
 * more https://github.com/jespanag/Laravel-Proxy-Helper
 */
...
class ProxyHelper
{
    ...
    {
        /*, $useDefaultHeaders = false*/ $this->originalRequest = $request;
    ...
    public function preserveQuery($preserve)
    {
    ...
    private function getRequestInfo()
    {
        return [
            "type" => $this->originalRequest->isJson()
                ? "json"
                : (strpos($this->originalRequest->header("Content-Type"), "multipart") !== false
                    ? "multipart"
