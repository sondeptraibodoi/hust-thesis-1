...
class AggridHelper
{
    ...
    public static function convertDateCusotomFilterType($filter, $query, $key, $where = "where")
    {
        if (isset($filter["filter"])) {
            $filter["filter"] = Carbon::createFromFormat(config("app.format_datetime_send"), $filter["filter"]);
        }

        if (isset($filter["filterTo"])) {
            $filter["filterTo"] = Carbon::createFromFormat(config("app.format_datetime_send"), $filter["filterTo"]);
        }
