...
class SinhVien extends Model
{
    ...
    protected $fillable = ["name", "email", "mssv", "group", "birthday"];
    protected $casts = [
        "birthday" => "date",
    ];
    ...
    {
        return $this->hasMany(HocPhanBaiThi::class, "sinh_vien_id");
    }

    public function diemHocPhanChuong()
    {
        return $this->hasMany(DiemHocPhanChuongView::class, "sinh_vien_id");
    }
}
