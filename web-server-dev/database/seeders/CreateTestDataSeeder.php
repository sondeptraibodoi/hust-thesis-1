    ...
    public function run()
    {
        ...
        foreach ($users as $user) {
            ...
            if (isset($sinhvien_info)) {
                ...
                $check->update([
                    "info_id" => $sinhvien->getKey(),
                    "info_type" => $sinhvien->getMorphClass(),
                ]);
            }
            if (isset($giaovien_info)) {
                $giaovien = GiaoVien::updateOrCreate(["email" => $giaovien_info["email"]], $giaovien_info);
                $check->update([
                    "info_id" => $giaovien->getKey(),
                    "info_type" => $giaovien->getMorphClass(),
                ]);
            }
        }
        $lop = Lop::updateOrCreate(
            ...
            [
                "ma_hp" => "MI1144",
                "ten_hp" => "Đại số tuyến tính",
                "loai" => "LT",
                "ki_hoc" => "20223",
                "phong" => "Dữ liệu test",
            ]
        );
        $lop2 = Lop::updateOrCreate(
            ["ma" => "100001", "ma_kem" => "100000"],
            [
                "ma_hp" => "MI1144",
                "ten_hp" => "Đại số tuyến tính",
                "loai" => "BT",
        ...
        $lop3 = Lop::updateOrCreate(
            ["ma" => "100002", "ma_kem" => "100000"],
            [
                "ma_hp" => "MI1144",
                "ten_hp" => "Đại số tuyến tính",
                "loai" => "BT",
        ...
        $lop_thi2 = LopThi::updateOrCreate(
            ["lop_id" => $lop2->getKey(), "ma" => "100001-Nhóm 1"],
            [
                "loai" => "GK",
                "ngay_thi" => "2023-10-10",
                "kip_thi" => "10h30-12h",
        ...
        $lop_thi3 = LopThi::updateOrCreate(
            ["lop_id" => $lop3->getKey(), "ma" => "100001-Nhóm 2"],
            ["loai" => "GK", "ngay_thi" => "2023-10-10", "kip_thi" => "10h-12h"]
        );
        ...
        $bang_diem = BangDiem::updateOrCreate(
            [
                "ma_hp" => "MI1144",
                "ten_hp" => "Đại số tuyến tính",
                "ki_hoc" => "20223",
            ...
            [
                "duong_dan_tap_tin" => "",
                "ngay_cong_khai" => Carbon::now()->subDay(),
                "ngay_ket_thuc_phuc_khao" => $ngay_ket_thuc_phuc_khao,
                "loai" => "nhap_tay",
                "ki_thi" => "GK",
            ]
        );
        ...
        Diem::updateOrCreate(
            [
                "bang_diem_id" => $bang_diem->getKey(),
                "lop_thi_id" => $lop_thi2->getKey(),
                "sinh_vien_id" => $sinh_vien2->getKey(),
                "nguoi_nhap_id" => 1,
            ],
            ["diem" => 8]
        );
