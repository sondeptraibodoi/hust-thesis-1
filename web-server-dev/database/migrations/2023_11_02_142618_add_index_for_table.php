...
class AddIndexForTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement(
            "CREATE INDEX IF NOT EXISTS ph_diem_danhs_lop_id_sinh_vien_id ON ph_diem_danhs (lop_id,sinh_vien_id)"
        );

        DB::statement("CREATE INDEX IF NOT EXISTS ph_lop_this_lop_id ON ph_lop_this (lop_id)");

        DB::statement(
            "CREATE INDEX IF NOT EXISTS ph_lop_thi_giao_viens_lop_thi_id ON ph_lop_thi_giao_viens (lop_thi_id)"
        );
        DB::statement(
            "CREATE INDEX IF NOT EXISTS ph_lop_thi_giao_viens_lop_thi_id ON ph_lop_thi_giao_viens (giao_vien_id)"
        );
        ...
        DB::statement(
            "CREATE INDEX IF NOT EXISTS d_diem_nhan_dien_lop_this_bang_diem_id ON d_diem_nhan_dien_lop_this (bang_diem_id)"
        );
    }
