...
class CreateTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('loai_bai', function (Blueprint $table) {
            ...
            $table->integer('thoi_gian'); // Thời gian làm bài tính bằng phút
        });
        ...
        Schema::create('de_thi', function (Blueprint $table) {
            ...
            $table->foreignId('loai_bai_id')->constrained('loai_bai')->onDelete('cascade');
        ...
        Schema::create('bai_kiem_tra', function (Blueprint $table) {
            ...
            $table->foreignId('mon_hoc_id')->constrained('mon_hoc')->onDelete('cascade');
            $table->foreignId('loai_bai_id')->constrained('loai_bai')->onDelete('cascade');
            $table->integer('diem')->default(0); // Điểm số của bài kiểm tra
            $table->foreignId('de_thi_id')->constrained('de_thi')->onDelete('cascade');
