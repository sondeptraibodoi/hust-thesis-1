...
export default {
  ...
  list: (params: CallbackParams) => sdk.post("sinh-vien-phuc-khao-list", params),
  create: (item: Partial<PhucKhao>) => sdk.post("sinh-vien-phuc-khao", item),
  getDetail: (id: string | number, params: any = {}) => sdk.get<PhucKhao>(`sinh-vien-phuc-khao/${id}`, { params }),
