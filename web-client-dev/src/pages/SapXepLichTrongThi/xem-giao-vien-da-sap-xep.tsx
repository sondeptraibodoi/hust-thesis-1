      ...
      <div className="flex flex-wrap gap-2 mb-2">
        ...
        <Space className="bg-gray-200 border-solid border border-[#c0c0c0] py-2 px-4 rounded-lg">
          ...
          <Select
            ...
            options={kipThiValue}
          />
          <Button disabled={listLopThi.length > 1 ? false : true} onClick={getDetailData} loading={SearchLoading}>
            {t("action.filter")}
          </Button>
        </Space>
      </div>
      <Table tableLayout="fixed" bordered dataSource={listLopThi} columns={columnsHeader} />
    </PageContainer>
  );
}
