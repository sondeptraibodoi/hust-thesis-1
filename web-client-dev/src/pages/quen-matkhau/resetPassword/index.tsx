...
const ChangePassword: React.FC = () => {
  ...
  const [text, setText] = useState("Đường dẫn đã quá hạn vui lòng thực hiện lại bước gửi Email");
    ...
    <>
      ...
      <Row justify="center" align="middle" style={{ height: "100%" }}>
        <Space direction="vertical">
          <Card className="smh:max-h-[70vh] sm:w-[600px]" style={{ background: "#ffff", minWidth: "30vw" }}>
            {!show && (
              <div
                style={{
                  display: "flex",
            ...
            {show && (
              <div className="my-login-validation ">
                ...
                <Form {...layout} method="POST" noValidate onFinish={onFinish} style={{ maxWidth: 500 }}>
                  <Form.Item
                    name="password"
                    label="Mật khẩu mới"
                    rules={[
