...
const ModalExportThucTap: FC<Props> = ({ showModal, setShowModal, api, text }) => {
    ...
    <>
      <Modal centered footer={<></>} className="relative" open={showModal} onCancel={() => handleCancel()} width={570}>
        ...
        <div className="modal-title-wapper">
          <p className="modal-title">Xuất danh sách thực tập</p>
        </div>
        <Form
        ...
        >
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Vui lòng chọ kì học "
              }
            ]}
          >
            <Select allowClear options={kiHoc} placeholder={"Kì học"}></Select>
          </Form.Item>
          <Form.Item label="Giáo viên hướng dẫn" name="giao_vien_hd">
            <Select allowClear options={giao_vien_hd} placeholder={"Giáo viên hướng dẫn"}></Select>
          </Form.Item>
...
export default ModalExportThucTap;
