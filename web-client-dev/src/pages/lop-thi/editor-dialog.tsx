        ...
        <div className="model-container">
          ...
          <div className="scrollable-content">
            ...
            >
              ...
              <Form.Item label="Mã lớp học" name="lop_id" rules={[{ required: true, message: t("required.lop_hoc") }]}>
                <Select>
              ...
              <Form.Item label="Đợt thi" name="loai" rules={[{ required: true, message: t("required.loai") }]}>
                <Select>
                  {loaiData.map((item) => (
              ...
              <Form.Item label="Ngày thi" name="ngay_thi" rules={[{ required: true, message: t("required.ngay_thi") }]}>
                <DatePicker placeholder="Chọn ngày thi" format="DD/MM/YYYY" className="w-full" />
              </Form.Item>
              {/* <Form.Item
              label="Kíp thi"
              name="kip_thi"
            ...
            >
              ...
              <Form.Item label="Kíp thi" name="kip_thi" rules={[{ required: true, message: t("required.ngay_thi") }]}>
                <Input onChange={() => handleChange("kip_thi")} placeholder="ex: 7h30-10h"></Input>
              </Form.Item>
