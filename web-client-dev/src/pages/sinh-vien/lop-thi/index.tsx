...
const LopThiPage = () => {
  ...
  const contentDesktop = () => kiHienGio && <LopThiPageDesktop kiHoc={kiHoc} kiHienGio={kiHienGio} />;
  const contentMobile = () => kiHienGio && <LopThiPageMobile kiHoc={kiHoc} kiHienGio={kiHienGio} />;
  return (
    <>
      <PageContainer title="Danh sách lớp thi">
...
const LopThiPageDesktop: FC<{ kiHoc: string[]; kiHienGio: string }> = ({ kiHienGio }) => {
...
const LopThiPageMobile: FC<{
    ...
    const sendData: any = {
      filterModel: {
        ...
        phong_thi: {
          filterType: "text",
          type: "contains",
          filter: filter.phong_thi
        },
        kip_thi: {
          filterType: "text",
          type: "contains",
          filter: filter.kip_thi
        }
      },
      count: 1,
      hasMoreItems: true,
  ...
  const Filter = (
    ...
    >
      <Row>
        ...
        <Col xs={24} sm={12} md={8} lg={8} xxl={6}>
          <Form.Item className="col-span-12 sm:col-span-6 lg:col-span-3" name="ma" label="Mã lớp thi">
            <Input
              onPressEnter={(e: any) => {
                pagination.page = 1;
        ...
        <Col xs={24} sm={12} md={8} lg={8} xxl={6}>
          <Form.Item className="col-span-12 sm:col-span-6 lg:col-span-3" name="phong_thi" label="Phòng thi">
            <Input
              onPressEnter={(e: any) => {
                pagination.page = 1;
                handleFieldChanged("phong_thi", e.target.value);
              }}
            />
          </Form.Item>
        </Col>
  ...
  if (loading) {
    ...
    Content = <div className="p-2 text-center"> Sinh viên chưa tham gia lớp thi nào</div>;
  } else {
    Content = (
      <>
