...
const TroLyHocPhanListTaiLieuPage: FC<{ info: HocPhanUser }> = ({ info }) => {
  ...
  const getData = useCallback(async () => {
    ...
    try {
      const res = await taiLieuHocPhanApi.list(info);
      items = res.data;
  ...
  return (
    <>
      ...
      <DeleteDialog
        ...
        apiDelete={() => data && taiLieuHocPhanApi.delete(data.id, info.ma_hoc_phan)}
        setKeyRender={setKeyRender}
      />
    </>
  );
...
export default TroLyHocPhanListTaiLieuPage;
