...
const PhucKhaoFrom = () => {
  ...
  return (
    <div className="phuc-khao-sinh-vien-form" style={{ backgroundColor: "#f5f5f5", padding: 10 }}>
      <Row justify="center">
          ...
          <div style={{ backgroundColor: "white", padding: 20 }}>
            <Row justify="space-evenly">
              <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                <div>
                  <Input size="large" placeholder="MSSV" style={{ margin: "10px 0 " }} value={data?.mssv} disabled />
                  <Input
                    size="large"
                ...
                <div className="phuc-khao-sinh-vien-form__sub">
                  <Row justify="center">
                    ...
                    <p style={{ margin: "10px 0" }}>
                      <strong>Bước 1.</strong> Kiểm tra thông tin ở biểu mẫu bên trái và nhấn nút Yêu cầu phúc khảo
                    </p>
                    <p style={{ margin: "10px 0" }}>
                      <strong>Bước 2.</strong> Chuyển khoản phí phúc khảo tới tài khoản ngân hàng theo hướng dẫn chi
                      tiết
                    </p>
                    ...
                    <h5 style={{ margin: "13px", color: "#f5222d" }}>
                      Mọi thông tin thắc mắc vui lòng điện thoại trực tiếp cán bộ theo số máy: 09437558xx
                    </h5>
                  </Row>
                </div>
              </Col>
