      ...
      <Modal centered footer={<></>} className="relative" open={showModal} onCancel={() => handleCancel()}>
        ...
        <Form layout="vertical" className="base-form" onFinish={onFinish} form={form}>
          <Form.Item
            ...
            validateStatus={validateForm(errorMessage?.errors?.current_password?.length)}
            help={errorMessage?.errors?.current_password ? errorMessage?.errors?.current_password[0] : undefined}
          >
          ...
          <Form.Item
            ...
            validateStatus={validateForm(errorMessage?.errors?.password_confirmation?.length)}
            help={
              errorMessage?.errors?.password_confirmation ? errorMessage?.errors?.password_confirmation[0] : undefined
            }
          >
            <Input.Password onChange={() => handleChange("password_confirmation")}></Input.Password>
          </Form.Item>
