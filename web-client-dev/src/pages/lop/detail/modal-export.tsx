...
const ModalExport: FC<Props> = ({ showModal, setShowModal, data, translation, exportAll, api, apiExportAll, text }) => {
    ...
    <>
      <Modal centered footer={<></>} className="relative" open={showModal} onCancel={() => handleCancel()}>
        ...
        <div className="modal-title-wapper">
          <p className="modal-title">{exportAll ? t("title.export_all") : t("title.export")}</p>
        </div>
        <Form
