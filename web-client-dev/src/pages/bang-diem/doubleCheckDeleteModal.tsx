...
const DoubleCheckDeleteModal: FC<Props> = (props) => {
  const { openModal, closeModal, name, setKeyRender, apiDelete, translation } = props;
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="modal-title-wapper">
          ...
          <p className="modal-suptitle">
            Bạn có chắc muốn xoá <b> {name} </b> này không? Hành động này sẽ xoá hết dữ liệu điểm của môn.
          </p>
        </div>
      </Modal>
      <Modal
      ...
      >
        ...
        <div className="modal-title-wapper">
          <p className="modal-suptitle">Bạn có chắc muốn xoá ? Hành động này không thể được hoàn tác.</p>
        </div>
      </Modal>
    </div>
  );
